  ...
  return (
    <footer className="flex items-center bg-gray-200 dark:bg-gray-800 text-gray-700 dark:text-gray-300" style={{ padding: "10px", marginTop: "1rem"}}>
       ...
       <div style={{display: "flex", justifyContent: "space-between"}}>
            <a href="https://github.com/RanulJaya" className="transition delay-100 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-sky-700" target="_blank" rel="noopener noreferrer">
                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 496 512" className="Home_socialIcons__FC+ik " height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
